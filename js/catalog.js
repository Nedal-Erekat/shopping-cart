...
function updateCounter() {
  ...
  total.textContent=`Total Items= ${totalItems} , Total Qty= ${totalQty} `;
...
populateForm();
// console.log('hi i am the result ',localStorage.getItem(JSON.parse('cart')));
